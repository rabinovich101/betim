          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <div className="absolute left-4 top-1/2 -translate-y-1/2 text-[#a0a0b8] pointer-events-none">
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-4 py-3.5 bg-[#232438] border ${errors.fullName ? 'border-red-500' : 'border-white/10'} rounded-xl text-white placeholder-[#6a6a7e] focus:outline-none focus:border-[#00ff87] focus:bg-[#2a2b3f] transition-all ${focusedField === 'fullName' ? 'border-[#00ff87] bg-[#2a2b3f]' : ''}`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onBlur={() => setFocusedField(null)}
                  className={`w-full pl-12 pr-4 py-3.5 bg-[#232438] border ${errors.username ? 'border-red-500' : 'border-white/10'} rounded-xl text-white placeholder-[#6a6a7e] focus:outline-none focus:border-[#00ff87] focus:bg-[#2a2b3f] transition-all ${focusedField === 'username' ? 'border-[#00ff87] bg-[#2a2b3f]' : ''}`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onBlur={() => setFocusedField(null)}
                  className={`w-full pl-12 pr-4 py-3.5 bg-[#232438] border ${errors.email ? 'border-red-500' : 'border-white/10'} rounded-xl text-white placeholder-[#6a6a7e] focus:outline-none focus:border-[#00ff87] focus:bg-[#2a2b3f] transition-all ${focusedField === 'email' ? 'border-[#00ff87] bg-[#2a2b3f]' : ''}`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  onBlur={() => setFocusedField(null)}
                  className={`w-full pl-12 pr-12 py-3.5 bg-[#232438] border ${errors.password ? 'border-red-500' : 'border-white/10'} rounded-xl text-white placeholder-[#6a6a7e] focus:outline-none focus:border-[#00ff87] focus:bg-[#2a2b3f] transition-all ${focusedField === 'password' ? 'border-[#00ff87] bg-[#2a2b3f]' : ''}`}
            ...
            <div>
              <label className="block text-sm font-medium text-[#a0a0b8] mb-2">Confirm Password</label>
              <div className="relative">
                <div className="absolute left-4 top-1/2 -translate-y-1/2 text-[#a0a0b8] pointer-events-none">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                    <rect x="3" y="11" width="18" height="11" rx="2" ry="2"/>
                ...
                <input
                  ...
                  onBlur={() => setFocusedField(null)}
                  className={`w-full pl-12 pr-12 py-3.5 bg-[#232438] border ${errors.confirmPassword ? 'border-red-500' : 'border-white/10'} rounded-xl text-white placeholder-[#6a6a7e] focus:outline-none focus:border-[#00ff87] focus:bg-[#2a2b3f] transition-all ${focusedField === 'confirmPassword' ? 'border-[#00ff87] bg-[#2a2b3f]' : ''}`}
            ...
            {/* Date of Birth Field */}
            <div>
              <label className="block text-sm font-medium text-[#a0a0b8] mb-2">Date of Birth</label>
              <div className="relative">
                <div className="absolute left-4 top-1/2 -translate-y-1/2 text-[#a0a0b8] pointer-events-none">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                <input
                  ...
                  className={`w-full pl-12 pr-4 py-3.5 bg-[#232438] border ${errors.dateOfBirth ? 'border-red-500' : 'border-white/10'} rounded-xl text-white placeholder-[#6a6a7e] focus:outline-none focus:border-[#00ff87] focus:bg-[#2a2b3f] transition-all ${focusedField === 'dateOfBirth' ? 'border-[#00ff87] bg-[#2a2b3f]' : ''}`}
                />
            ...
            {/* Country Field */}
            <div>
              <label className="block text-sm font-medium text-[#a0a0b8] mb-2">Country</label>
              <div className="relative">
                <div className="absolute left-4 top-1/2 -translate-y-1/2 text-[#a0a0b8] pointer-events-none z-10">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                <select
                  ...
                  onBlur={() => setFocusedField(null)}
                  className={`w-full pl-12 pr-4 py-3.5 bg-[#232438] border ${errors.country ? 'border-red-500' : 'border-white/10'} rounded-xl text-white focus:outline-none focus:border-[#00ff87] focus:bg-[#2a2b3f] transition-all appearance-none ${focusedField === 'country' ? 'border-[#00ff87] bg-[#2a2b3f]' : ''}`}
                >
            ...
            {formData.country === 'US' && (
              <div>
                <label className="block text-sm font-medium text-[#a0a0b8] mb-2">State</label>
                <div className="relative">
                  <div className="absolute left-4 top-1/2 -translate-y-1/2 text-[#a0a0b8] pointer-events-none z-10">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                  ...
                  <select
                    ...
                    onBlur={() => setFocusedField(null)}
                    className={`w-full pl-12 pr-4 py-3.5 bg-[#232438] border ${errors.state ? 'border-red-500' : 'border-white/10'} rounded-xl text-white focus:outline-none focus:border-[#00ff87] focus:bg-[#2a2b3f] transition-all appearance-none ${focusedField === 'state' ? 'border-[#00ff87] bg-[#2a2b3f]' : ''}`}
                  >
            ...
            <div>
              <label className="block text-sm font-medium text-[#a0a0b8] mb-2">Promo Code (Optional)</label>
              <div className="relative">
                <div className="absolute left-4 top-1/2 -translate-y-1/2 text-[#a0a0b8] pointer-events-none">
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                ...
                <input
                  ...
                  onBlur={() => setFocusedField(null)}
                  className={`w-full pl-12 pr-4 py-3.5 bg-[#232438] border border-white/10 rounded-xl text-white placeholder-[#6a6a7e] focus:outline-none focus:border-[#00ff87] focus:bg-[#2a2b3f] transition-all ${focusedField === 'promoCode' ? 'border-[#00ff87] bg-[#2a2b3f]' : ''}`}
